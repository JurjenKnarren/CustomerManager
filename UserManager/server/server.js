...
//Local Connection 
var conn = 'mongodb://localhost/usermanager';
...
app.get(baseUrl + 'Users', api.users);
app.get(baseUrl + 'User/:id', api.user);
app.get(baseUrl + 'UsersSummary', api.usersSummary);
app.get(baseUrl + 'UserById/:id', api.user);

app.post(baseUrl + 'PostUser', api.addUser);
app.put(baseUrl + 'PutUser/:id', api.editUser);
app.delete(baseUrl + 'DeleteUser/:id', api.deleteUser);
